...
for i, f in enumerate(files):
    ...
    # RULE 2: Placeholder formatting for Magde & Ahmed
    if id_safe == "chuffed_130195":
        text = re.sub(r"## 📝 1\. Campaign Title:\n.*?\n\n", "## 📝 1. Campaign Title:\nMagde & Ahmed\n\n", text, flags=re.DOTALL)
        text = re.sub(r"## 📖 2\. Campaign Story:\n> .*?\n\n", "## 📖 2. Campaign Story:\n> Please donate to Magde & Ahmed. Thank you for your support.\n\n", text, flags=re.DOTALL)
