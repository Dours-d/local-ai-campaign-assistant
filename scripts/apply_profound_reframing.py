...
for filename in os.listdir(directory):
    if filename.endswith(".txt"):
        ...
        ar_msg += f"3. صندوق المظلة الجماعي (Umbrella Fund): حملتكم محمية بدرعنا الجماعي. يضمن هذا الصندوق وصول المساعدات بالكامل عبر تجنب الرسوم البنكية الباهظة، مع تتبع كل تبرع مباشرة إلى المعرف الخاص بكم: {bid}.\n"
        ar_msg += f"4. ذكاء 'نور' (Noor AI): نحن نحفظ إرثكم. يتم تخليد قصتكم في مستودع المعرفة (دنيا)، لضمان عدم نسيان صمودكم أبداً: https://dours-d.github.io/local-ai-campaign-assistant/brain.html\n"
        ...
        en_msg += f"3. The Collective Umbrella Fund: Your campaign is protected by our collective Shield. This fund ensures zero-waste delivery by avoiding heavy bank fees, tracking every donation directly to your ID: {bid}.\n"
        en_msg += f"4. Noor AI (Repository of Knowledge): We are preserving your legacy. Your story is being immortalized in the Noor AI Knowledge Base (Dunya): https://dours-d.github.io/local-ai-campaign-assistant/brain.html\n"
