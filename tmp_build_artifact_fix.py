...
with open(out_file, "w", encoding="utf-8") as out:
    ...
    for i, f in enumerate(files):
        ...
        # Replace broken unicode character with correct one
        text = text.replace("", "🤝")
        ...
        if img_path:
            ...
            try:
                ...
                # On Windows, add a leading slash so it looks like an absolute path to the parser
                if len(md_img_path) > 1 and md_img_path[1] == ":":
                    md_img_path = "/" + md_img_path
